    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white p-6 overflow-hidden shadow-sm sm:rounded-lg mx-auto">
            ...
            <thead>
              <tr>
                ...
                <th class="w-1/12 text-left">
                  <span class="hover:italic">@sortablelink('release_year', '公開')</span>
                </th>
              ...
              <tbody>
                <tr class="divide-y divide-slate-400">
                  <td class="border-t border-slate-400 w-5/12 text-indigo-600"><a href="/movie/{{ $movie['id'] }}"
                      class="text-blue font-medium inline-block mx-auto mr-0 py-2 px-1 focus:outline-none hover:text-rose-500">{{ $movie->title }}</a></button>
                  </td>
                  <td class="w-4/12">
        ...
        <button onclick="history.back()"
          class="text-white block bg-indigo-500 mx-auto border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">検索に戻る</button>
      </div>
    </div>
</x-app-layout>
