...
1968年7月14日、この日「続夕陽のガンマン」と「サムライ」を観なかったら、私は50年以上映画ファンであり続ける事はなかったかも知れない。自分史の中でそういう位置を占めているのだ。',
            ...
            array (
                ...
                'movie_id' => 74,
                'user_id' => 1,
                'comment' => '誰しも一度はこんな生活を望んだことがあるのではないか？決断して実行することはないが、そんな体験を感じることができた。その生活にも苦しみがありそれが人生であるということがよくわかる映画でした。',
                'rating' => 4,
                'created_at' => '2024-10-10 08:43:03',
                'updated_at' => '2024-10-10 08:43:03',
            ),
            52 => 
            array (
                'id' => 54,
                'movie_id' => 139,
                'user_id' => 1,
                'comment' => '都会の夜景、銃撃戦、パッと散る血飛沫、クラブの中で明滅する光と影、映像的に美しくて満足度が高い。各種銃火器が贅沢に出てくるのも良き。
たった一つの希望を奪われた男が、あと先考えないで突っ走る、過剰なまでの復讐に痺れます。',
                'rating' => 4,
            ...
            array (
                ...
                'movie_id' => 138,
                'user_id' => 1,
                'comment' => '福祉や教育の重要性を再認識させる内容。
純真無垢な子供達の将来像が、いかがわしい大人達の姿に重なり、問題の根深さに気付かされる。',
                'rating' => 4,
                'created_at' => '2024-10-10 10:54:08',
                'updated_at' => '2024-10-10 10:54:08',
            ),
            54 => 
            array (
                'id' => 56,
...
ストーリーが壮大且つよく一本の映画に纏められたものだと感心する程ボリュームのある内容なので、出来れば3部作、せめて前後編に分けて欲しかった気がします。',
            ...
            array (
                ...
                'movie_id' => 133,
                'user_id' => 4,
                'comment' => '様々な言葉が混ざり合い、独特の世界観。観ていて不思議。
...
自分のやっていることは無駄じゃないって。',
            ...
            array (
                ...
                'movie_id' => 108,
                'user_id' => 4,
                'comment' => 'アルツハイマーになった、かつての凄腕暗殺者のお話。
最強おじいちゃんてだけで渋くてかっこいいこと間違い無しなんだけど、肝心のアルツハイマーの描写が、それはアルツハイマーなのか？っていうものでした。
そこさえ気にならなければ、割と面白かったよ！',
                'rating' => 3,
            ...
            array (
                ...
                'movie_id' => 103,
                'user_id' => 4,
                'comment' => '只々シャーリーズ・セロンの凄まじい役作りに感服。
容姿が本物のアイリーンそっくりでホント驚いたわぁ。',
                'rating' => 4,
...
そこだけ聞くと子供を受け止めれない親が悪いよな…って思うけど
でも子供時代のアイリーンの素行がどうだったのかな？とか他の兄弟は？って

それにしても　生活を変えたいのに変えれない…そこから…',
                'rating' => 5,
                'created_at' => '2024-10-10 11:16:33',
                'updated_at' => '2024-10-10 11:16:33',
            ),
            60 => 
            array (
                'id' => 62,
                'movie_id' => 120,
                'user_id' => 2,
                'comment' => '泣ける。こんな悲しい話は無いよ。心温まるラストだけど、クライマックスまではちゃんとホラーしててヒヤヒヤしたシーン多数。だるまさんが転んだのシーンはムリムリムリ…。',
                'rating' => 3,
            ...
            array (
                ...
                'movie_id' => 140,
                'user_id' => 2,
                'comment' => '久しぶりに見たけど古い映像が余計に怖く感じる。これぞジャパニーズホラーという感じ
黒木瞳さんも水川あさみさんも若い！',
                'rating' => 4,
            ...
            array (
                ...
                'movie_id' => 124,
                'user_id' => 2,
                'comment' => '日蝕がストーリーをよりドラマチックにしてて大興奮です。黙秘は母の愛にもかかっているのか。
...
セリフの使い方丁寧でとてもいい。',
            ...
            array (
                ...
                'movie_id' => 135,
                'user_id' => 1,
                'comment' => 'すげー良かった。3時間ずっと舞台観てる感じだった。田舎の嫌〜〜〜〜な感じが出てて日本以外もああいう雰囲気なんだなと思った。ニコール・キッドマン背でけー。トムってMCUのヴィジョンか！！',
                'rating' => 4,
...
こんな映画を作ってくれてありがとうございますという…',
            ...
            array (
                ...
                'movie_id' => 122,
                'user_id' => 1,
                'comment' => '素直に良い映画観たなって思えるし
なんかいい映画教えてって言われた時にお勧め出来る映画でもある',
                'rating' => 4,
            ...
            array (
                ...
                'movie_id' => 113,
                'user_id' => 1,
                'comment' => '深海へ向かう路は死に街道をイメージする。死と隣り合わせの素潜り競技の世界に位置する男達は、単に競技をしたいわけで無く、海そのもの、本来は生物を生み出すスープのはじまりのはじまりを追い求めている。イルカという知的哺乳類が象徴するように、海は進化を助けると共に、その深海では生物の始まりの死の世界。そんなものに魅入られた人間には未来はない。あるとすれば仮初めに誕生させる新しい生命だ。',
                'rating' => 4,
                'created_at' => '2024-10-10 11:32:50',
                'updated_at' => '2024-10-10 11:32:50',
            ),
            67 => 
            array (
                'id' => 69,
                'movie_id' => 40,
                'user_id' => 1,
                'comment' => '圧巻。バタフライエフェクトっぽいがこちらの方が好み。もう一度見たい。',
                'rating' => 4,
            ...
            array (
                ...
                'movie_id' => 117,
                'user_id' => 2,
                'comment' => 'かつてのスターレスラーが落ちぶれて、一人娘には見放され、場末のストリッパーに心を惹かれ、病気で一旦引退して、一念発起してリングに上がる、ベタベタなストーリーです。
